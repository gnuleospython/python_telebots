...
if not API_KEY:
    raise ValueError("La API_KEY_GEMINI no está configurada en el archivo .env")
...
if not model_to_use:
    raise Exception("No se encontró un modelo Gemini adecuado que soporte 'generateContent' de la lista preferida.")
